...
class ModelTraining:
    ...
    def load_and_split_data(self):
        try:
            logger.info(f"Start loading train data from {self.train_path}")
            train_df = load_data(self.train_path)

            logger.info(f"Start loading test data from {self.test_path}")
    ...
    def train_lgbm(self, X_train, y_train):
        try:
            ...
            best_lgbm_model = random_search.best_estimator_   # random_search is the CV object
